...
|---|---|
| In-State Resident | Full-time domicile in state for required period |
| Out-of-State Non-Resident | Does not meet residency criteria |
| Military / Veteran | Active duty, veteran, or dependent — verify state/federal provisions |
| Online / Distance Learning | May have a separate rate; verify institutional policy |
| International (Non-Immigrant) | Separate fee structure; verify |
| Graduate vs. Undergraduate | Separate rate schedules |
| Per-credit vs. Flat Rate | Varies by enrollment status (full-time vs. part-time) |

> Current tuition rate schedule: <!-- add link -->
...
|---|---|---|
| State Residency Statutes | Legal definition of residency for tuition purposes | <!-- link --> |
| Institutional Residency Policy | Internal policy governing classification decisions | <!-- link --> |
| Tuition Rate Schedule | Current rates by category | <!-- link --> |
| Residency Appeal Form | Form for students to appeal classification | <!-- link --> |