...
A central index of important links, tools, and resources used in the Registrar's Office.
...
## 🌍 Immigration & Credential Evaluation

| Resource | Description | Link |
|---|---|---|
| NAFSA Immigration Classifications Guide (2023) | Quick reference for immigration classifications and employment | [nafsa.org](https://www.nafsa.org/bookstore/2023-immigration-classifications-and-employment-quick-reference-guide) |
| NAFSA Immigration Classifications Poster (2023) | Visual reference poster | [nafsa.org](https://www.nafsa.org/bookstore/2023-immigration-classifications-and-employment-poster) |
| SBCC Policy — Admission to Colleges (1D SBCCC 400.2) | State Board policy on admission and SSNs | [ncccsstg.wpengine.com](https://ncccsstg.wpengine.com/sites/default/files/state-board/policy/pol_04_-_proposed_amendment_to_1d_sbccc_400.2_-_admission_to_colleges_ssns.pdf) |
| USCIS — Temporary Protected Status | Federal info on TPS | [uscis.gov](https://www.uscis.gov/humanitarian/temporary-protected-status) |
| USCIS — Employment Authorization | Federal info on EADs | [uscis.gov](https://www.uscis.gov/employment-authorization) |
| NC General Statute § 115D-39 | NC statute on community college admissions | [ncleg.gov](https://www.ncleg.gov/enactedlegislation/statutes/pdf/bysection/chapter_115d/gs_115d-39.pdf) |
| NCresidency.org Residency Guidebook | NC RDS guidebook (login required — contact Registrar's Office) | [ncresidency.org](https://www.ncresidency.org) |
| NACES | National Association of Credential Evaluation Services | [naces.org](https://www.naces.org) |
| AICE | Association of International Credential Evaluators | [aice-eval.org](https://www.aice-eval.org) |
| IERF | International Education Research Foundation publications | [ierf.org](https://ierf.org/for-institutions/ierf-publications/) |
| Scholaro | Foreign transcript evaluation service | [scholaro.com](https://www.scholaro.com/) |
| WES | World Education Services — required documents guide | [wes.org](https://applications.wes.org/required-documents) |
| ECE | Educational Credential Evaluators | [ece.org](https://www.ece.org/) |
| MyIEE | International Education Evaluations | [myiee.org](https://myiee.org/) |
| Josef Silny & Associates | International credential evaluation | [jsilny.org](https://www.jsilny.org/) |
| SpanTran | Transcript evaluation service | [spantran.com](https://spantran.com/) |
